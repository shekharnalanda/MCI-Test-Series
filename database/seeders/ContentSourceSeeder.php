    ...
    public function run(): void
    {
        ...
        $sources = [
            ...
            [
                ...
                'allow_question_generation' => true,
                'auto_publish_allowed' => true,
                'license_note' => 'Creative Commons CC0 1.0 public domain dedication for Wikidata structured data.',
                'usage_notes' => 'Use structured facts only, retain entity provenance, and create original bilingual wording.',
                'is_active' => true,
            ],
            [
